<x-app-layout>
    ...
    <div class="mx-auto max-w-7xl space-y-6 px-4 py-6 sm:px-6 lg:px-8">
        <div class="flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between">
            <div>
                <h2 class="text-2xl font-bold tracking-tight text-slate-800">Riwayat Stok Keluar</h2>
                <p class="mt-1 text-sm text-slate-500">Catatan barang yang keluar dari gudang.</p>
            </div>
            <a href="{{ route('stok.keluar.create') }}"
               class="inline-flex items-center justify-center gap-2 rounded-xl bg-red-600 px-4 py-2.5 text-sm font-semibold text-white shadow-sm shadow-red-600/30 transition hover:bg-red-700">
                            ...
                            <tr>
                                <td colspan="6" class="px-5 py-16">
                                    <div class="flex flex-col items-center gap-3 text-center">
                                        ...
                                        <div>
                                            <p class="font-medium text-slate-600">Belum ada transaksi keluar</p>
                                            <p class="mt-0.5 text-sm text-slate-400">Catat stok keluar pertama Anda.</p>
                                        </div>
                                    </div>
                                </td>
                            </tr>
